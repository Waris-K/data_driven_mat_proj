...
trainLabels = reshape(trainLabels, [1, 1, 162, numTrain]);
valLabels = reshape(valLabels, [1, 1, 162, numValidation]);
...
predictedValidationLabels = predict(net, valData);
